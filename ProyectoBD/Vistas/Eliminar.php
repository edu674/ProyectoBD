...
<main class="contpadding">
	...
	<div class="row">
		<div class="col s10 push-s1 pull-s1" id="mainbody">
            ...
            $key=$modelo->llaves($_POST["tabla1"]);
            ...
            <table class="responsive-table">
            	<thead class="blue">
            		...
            		<?php } ?>
            		  <th class="contable"><h6 align="center">Eliminar</h6></th>
            		</tr>
            	</thead>
            	<tbody class="white">
            		<tr>
            		...
            		<?php }?>
            		<td class="contable"><center><a href="../Controlador/Eliminar.php?id=<?php echo $buscar[$i][0] ?>" class="btn red">Eliminar</a></center></td>
            		</tr>
            	<?php  } ?>
